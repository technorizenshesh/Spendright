...
import com.my.spendright.databinding.ActivityConfirmShowmaxBinding;
...
public class ConfirmPaymentShowMaxAct extends AppCompatActivity {
    public String TAG = "ConfirmPaymentShowMaxAct";
    ActivityConfirmShowmaxBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_confirm_showmax);

        sessionManager = new SessionManager(ConfirmPaymentShowMaxAct.this);
        ...
        call.enqueue(new Callback<GetCategoryModelNew>() {
            ...
            public void onResponse(Call<GetCategoryModelNew> call, Response<GetCategoryModelNew> response) {
                ...
                if (finallyPr.getStatus().equalsIgnoreCase("1")) {
                    ...
                    CategoryAdapterNew customAdapter = new CategoryAdapterNew(ConfirmPaymentShowMaxAct.this, modelListCategory);
    ...
    private void PayAccount() {
        ...
        map.put("billersCode", phone);
        map.put("variationCode", variationCode);
        map.put("amount", amount);
        map.put("phone", phone);
        Log.e("ShowmaxPaymentRequest==",map.toString());

        Call<ResponseBody> call = RetrofitClients.getInstance().getApi().Api_pay_showmax(Preference.getHeader(ConfirmPaymentShowMaxAct.this), sessionManager.getUserID(), Request_IDNew, ServicesId, phone, variationCode, amount, phone);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(@NonNull Call<ResponseBody> call, @NonNull Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if(jsonObject.has("result")){
                            ...
                            if (result.getString("code").equals("000")) {
                                ...
                                Toast.makeText(ConfirmPaymentShowMaxAct.this, "SuccessFully Bill pay", Toast.LENGTH_SHORT).show();
                                ...
                                if (jsonObject.getString("status").equalsIgnoreCase("9")) {
                                    ...
                                    Toast.makeText(ConfirmPaymentShowMaxAct.this, getString(R.string.invalid_token), Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(ConfirmPaymentShowMaxAct.this, LoginActivity.class)
                                    ...
                                    chkPayStatus = true;
                                    Toast.makeText(ConfirmPaymentShowMaxAct.this, result.getString("response_description"), Toast.LENGTH_SHORT).show();
                                }
                            }
                            else {
                                binding.RRConfirm.setClickable(true);
                                ...
                                binding.imgBack.setClickable(true);
                                chkPayStatus = true;
                                Toast.makeText(ConfirmPaymentShowMaxAct.this, jsonObject.getString("response_description"), Toast.LENGTH_SHORT).show();
                            }
                        }
                        else {
                            binding.RRConfirm.setClickable(true);
                    ...
                    Toast.makeText(ConfirmPaymentShowMaxAct.this, "api working...", Toast.LENGTH_SHORT).show();
                    binding.RRConfirm.setClickable(true);
                    binding.RRConfirm.setFocusable(true);
                    binding.RRConfirm.setEnabled(true);
                    binding.RRConfirm.setBackground(getDrawable(R.drawable.border_btn));
    ...
    private void AddReportMethod(String status, String response) {
        ...
        Call<ResponseBody> call = RetrofitClients.getInstance().getApi()
                .Api_add_vtpass_book_payment(Preference.getHeader(ConfirmPaymentShowMaxAct.this), sessionManager.getUserID(), Request_IDNew, amount, ServicesId, ServicesName,
                        "TV Subscription", status, Current_date, BudgetAccountId, selectBugCategoryId, phone/*binding.edtDescription.getText().toString()*/, phone, binding.tax.getText().toString().replace("₦", ""), response, String.valueOf(discountPercent), "", "");
        Map<String, String> map = new HashMap<>();
        map.put("user_id", sessionManager.getUserID());
        map.put("request_id", Request_IDNew);
        map.put("amount", amount);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equalsIgnoreCase("1")) {
                        ...
                        startActivity(new Intent(ConfirmPaymentShowMaxAct.this, PaymentComplete.class));
                        finish();
                        ...
                        binding.imgBack.setClickable(true);
                        chkPayStatus = true;
                        Toast.makeText(ConfirmPaymentShowMaxAct.this, "" + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    }
                    ...
                    if (response.code() == 200) {
                        ...
                        if (jsonObject.getString("status").equalsIgnoreCase("1")) {
                            ...
                            if (discountAmount < 10) {
                                ...
                                if (discountAmount == 00)
                                    binding.tvDiscountAmount.setText("₦" + "0.0");
                            ...
                            if (Double.parseDouble(CommisionAmount) < 10) {
                                ...
                                if (Double.parseDouble(CommisionAmount) == 00)
                                    binding.tax.setText("₦" + "0.0");
            ...
            public void onResponse(Call<GetProfileModel> call, Response<GetProfileModel> response) {
                ...
                try {
                    ...
                    if (finallyPr.getStatus().equalsIgnoreCase("1")) {
                        ...
                        Toast.makeText(ConfirmPaymentShowMaxAct.this, "" + finallyPr.getMessage(), Toast.LENGTH_SHORT).show();
                        binding.progressBar.setVisibility(View.GONE);
                    }
    ...
    public void AlertDialogStatus(String msg) {
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(ConfirmPaymentShowMaxAct.this);
        ...
        builder1.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.dismiss();
                        startActivity(new Intent(ConfirmPaymentShowMaxAct.this, FundAct.class)
                                .addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP));
                        finish();
                    }
                });
    ...
    private void showDropDownCategory(View v, TextView textView, List<IncomeExpenseCatModel.Category> stringList) {
        PopupMenu popupMenu = new PopupMenu(ConfirmPaymentShowMaxAct.this, v);
