...
public class ServicesOperatorAdapter extends BaseAdapter {
    ...
    ImageView icon;
    ArrayList<GetOperatorModel.Content> code;

    public ServicesOperatorAdapter(Context applicationContext, ArrayList<GetOperatorModel.Content> code) {
