...
public class ServicesAireAdapter extends BaseAdapter {
    ...
    public ServicesAireAdapter(Context applicationContext, ArrayList<GetServiceElectricialModel.Content> code) {
