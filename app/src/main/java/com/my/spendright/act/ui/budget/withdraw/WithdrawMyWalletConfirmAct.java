...
public class WithdrawMyWalletConfirmAct extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(WithdrawMyWalletConfirmAct.this);
        initViews();
    }
        ...
        call.enqueue(new Callback<GetCategoryModelNew>() {
            ...
            public void onResponse(Call<GetCategoryModelNew> call, Response<GetCategoryModelNew> response) {
                ...
                if (finallyPr.getStatus().equalsIgnoreCase("1"))
                {
                    ...
                    CategoryAdapterNew customAdapter=new CategoryAdapterNew(WithdrawMyWalletConfirmAct.this,modelListCategory);
        ...
        loginCall.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equalsIgnoreCase("1")) {
                        startActivity(new Intent(WithdrawMyWalletConfirmAct.this,WithdrawCompleteAct.class));
                        finish();
    ...
    private void showDropDownCategory(View v, TextView textView, List<IncomeExpenseCatModel.Category> stringList) {
        PopupMenu popupMenu = new PopupMenu(WithdrawMyWalletConfirmAct.this, v);
