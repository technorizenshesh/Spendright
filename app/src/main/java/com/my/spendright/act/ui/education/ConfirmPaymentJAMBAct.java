...
import com.my.spendright.databinding.ActivityConfirmJambBinding;
...
public class ConfirmPaymentJAMBAct extends AppCompatActivity {
    public String TAG = "ConfirmPaymentJAMBAct";
    ActivityConfirmJambBinding binding;
    ...
    String variationCode="",profileId="",customerName="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this, R.layout.activity_confirm_jamb);

        sessionManager = new SessionManager(ConfirmPaymentJAMBAct.this);
        ...
        if(intent !=null)
        {
           ...
           // amount = "10.00";
            ...
            //   phone="+234"+phone1;
            binding.tvBillerCode.setText(profileId);
        ...
        call.enqueue(new Callback<GetCategoryModelNew>() {
            ...
            public void onResponse(Call<GetCategoryModelNew> call, Response<GetCategoryModelNew> response) {
                ...
                if (finallyPr.getStatus().equalsIgnoreCase("1"))
                {
                    ...
                    CategoryAdapterNew customAdapter=new CategoryAdapterNew(ConfirmPaymentJAMBAct.this,modelListCategory);
    ...
    private void PayAccount() {
        Call<ResponseBody> call = RetrofitClients.getInstance().getApi().Api_pay_jamb( Preference.getHeader(ConfirmPaymentJAMBAct.this),sessionManager.getUserID(),Request_IDNew,ServicesId,profileId,variationCode,amount,phone);
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                       ...
                       if(jsonObject.has("result")) {
                           ...
                           Log.e("Payment", "JAMB Payment Response :" + stringResponse);
                           if (result.getString("code").equals("000")) {
                               ...
                               Toast.makeText(ConfirmPaymentJAMBAct.this, "SuccessFully Bill pay", Toast.LENGTH_SHORT).show();
                               ...
                               chkPayStatus = true;
                               Toast.makeText(ConfirmPaymentJAMBAct.this, jsonObject.getString("response_description"), Toast.LENGTH_SHORT).show();
                           }
                       }
                           ...
                           Toast.makeText(ConfirmPaymentJAMBAct.this, getString(R.string.invalid_token), Toast.LENGTH_SHORT).show();
                           startActivity(new Intent(ConfirmPaymentJAMBAct.this, LoginActivity.class)
                           ...
                           binding.imgBack.setClickable(true);
                           chkPayStatus = true;
                           Toast.makeText(ConfirmPaymentJAMBAct.this, jsonObject.getJSONObject("error").getString("response_description"), Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ConfirmPaymentJAMBAct.this, response.message(), Toast.LENGTH_SHORT).show();
    ...
    private void AddReportMethod(String status,String response){
        ...
        Call<ResponseBody> call = RetrofitClients.getInstance().getApi()
                .Api_add_vtpass_book_payment(Preference.getHeader(ConfirmPaymentJAMBAct.this),sessionManager.getUserID(),Request_IDNew,amount,ServicesId,ServicesName,
                        "JAMB e-PIN",status,Current_date,BudgetAccountId,selectBugCategoryId,phone/*binding.edtDescription.getText().toString()*/,phone,binding.tax.getText().toString().replace("₦",""),response,String.valueOf(discountPercent),customerName,profileId);
        ...
        map.put("billers_code",profileId);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equalsIgnoreCase("1")) {
                        ...
                        startActivity(new Intent(ConfirmPaymentJAMBAct.this, PaymentComplete.class));
                        finish();
                        ...
                        binding.imgBack.setClickable(true);
                        chkPayStatus = true;
                        Toast.makeText(ConfirmPaymentJAMBAct.this, "" + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onResponse(Call<GetProfileModel> call, Response<GetProfileModel> response) {
                ...
                try {
                    ...
                    if (finallyPr.getStatus ().equalsIgnoreCase ("1")) {
                        ...
                        Toast.makeText (ConfirmPaymentJAMBAct.this, "" + finallyPr.getMessage (), Toast.LENGTH_SHORT).show ();
                        binding.progressBar.setVisibility (View.GONE);
                    }
    ...
    public void AlertDialogStatus(String msg){
        ...
        AlertDialog.Builder  builder1 = new AlertDialog.Builder(ConfirmPaymentJAMBAct.this);
        ...
        builder1.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.dismiss();
                        startActivity(new Intent(ConfirmPaymentJAMBAct.this, FundAct.class)
                                .addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP));
                        finish();
                    }
                });
    ...
    private void showDropDownCategory(View v, TextView textView, List<IncomeExpenseCatModel.Category> stringList) {
        PopupMenu popupMenu = new PopupMenu(ConfirmPaymentJAMBAct.this, v);
