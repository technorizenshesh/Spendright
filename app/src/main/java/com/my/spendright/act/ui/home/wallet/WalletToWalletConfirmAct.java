...
import com.my.spendright.databinding.ActivityWithdrawWalletPaymentConfirmBinding;
...
public class WalletToWalletConfirmAct extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_withdraw_wallet_payment_confirm);
        sessionManager = new SessionManager(WalletToWalletConfirmAct.this);
        initViews();
    }
    ...
    private void initViews() {
        ...
        if (getIntent() != null) {
           /* selectedUserId = getIntent().getStringExtra("beneficiaryId");
            beneficiaryUserId = getIntent().getStringExtra("beneficiaryUserId");
            ...
            binding.tvBeneficiaryAccountNo.setText(name);
            binding.tvBeneficiaryName.setText(userName);
            binding.tvBeneficiaryBank.setText(mobile);
                        ...
                        if (jsonObject.getString("status").equalsIgnoreCase("1")) {
                            ...
                            for (int i = 0; i < finallyPr.getResult().size(); i++) {
                                ...
                                if (finallyPr.getResult().get(i).getAmount().contains("-")) {
                                    ...
                                    if (Double.parseDouble(finallyPr.getResult().get(i).getAmount()) <= Double.parseDouble(amount))
                                        CommisionAmount = finallyPr.getResult().get(i).getAmount();
                                }
                            }
                            ...
                            Double FInalAmt = CmAmt + Double.parseDouble(amount);
        ...
        call.enqueue(new Callback<GetCategoryModelNew>() {
            ...
            public void onResponse(Call<GetCategoryModelNew> call, Response<GetCategoryModelNew> response) {
                ...
                if (finallyPr.getStatus().equalsIgnoreCase("1")) {
                    ...
                    CategoryAdapterNew customAdapter = new CategoryAdapterNew(WalletToWalletConfirmAct.this, modelListCategory);
        ...
        loginCall.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equalsIgnoreCase("1")) {
                        startActivity(new Intent(WalletToWalletConfirmAct.this, WithdrawCompleteAct.class));
                        finish();
    ...
    private void showDropDownCategory(View v, TextView textView, List<IncomeExpenseCatModel.Category> stringList) {
        PopupMenu popupMenu = new PopupMenu(WalletToWalletConfirmAct.this, v);
